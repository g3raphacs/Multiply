...
class Question
{
    ...
    public function __construct(int $id){
        ...
        '<section class="Quest tableSec txt-main-black">
            <header class="bck-main QuestTitle">
                <h2 class="txt-center f-18 flex"><span class="QuestTitleTxt txt-white quest">Question '.$id.' :</span></h2>
                <p class="txt-center"><img class="QuestIcon" src="media/sad.svg" alt="" width="45"></p>
            </header>
